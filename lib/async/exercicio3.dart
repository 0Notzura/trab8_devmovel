...
Future<String> greetUser() async {
  //Chama fetchUsername para obter o nome de usuário
...
Future<String> sayGoodbye() async {
  try {
    //Chama logoutUser e espera o resultado
    String result = await logoutUser();
  //Retorna a mensagem de despedida com o resultado
    return '$result Thanks, see you next time';
  } catch (e) {
    return 'Goodbye failed. Please try again later.';
  }
}
